...
export default function Word({ word, baseUrl }: any) {
  ...
  return <Link onClick={()=>rakibuContext.current.setOpen(true)} href={`${baseUrl}/${word.id}`} data-lang={word.lang} className='relative flex-shrink-0 inline-flex items-stretch py-1 px-4 text-xl font-semibold text-gray-600 border-2 rounded-sm border-b-8 data-[lang=en]:border-b-green-300 data-[lang=ar]:border-b-blue-300'>
    <div className="flex">
